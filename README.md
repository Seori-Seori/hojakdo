...
V1~V3.1 결과는 회귀 비교용으로 보존했다. V4는 승인된 V3.1 구도를 실제 리소스 전용 Watch Face Format v1 프로젝트에 연결한 프로덕션 후보다. 작은 비행 까치는 정적 자세와 높이를 맞춘 70×54로 축소했고, 시침은 길이와 착지점을 유지한 채 수직 두께를 24% 늘리고 밝기를 12% 낮췄다. `鵲虎圖`와 도장은 원 안쪽으로 옮겼다.
...
- 중앙 실시간 표시는 바늘·캐릭터·전경 가림막보다 위에 렌더해 가독성 고정
- 중앙 표시 묶음은 세로 20px를 내리고 가로 중심을 다이얼 정중앙 `x=225`에 정렬
...
- V1~V4 합계 50개 자동 테스트 통과
- 압축 해제 추정 메모리: 대화형 11.62MiB, AOD 정적 자산 5.82MiB
