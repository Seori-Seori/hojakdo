...
- 배터리 매화는 빈 가지 전경 가림막 위·시침과 분침 아래에서 5단계 조건을 적용해 만개와 바늘 가시성을 함께 유지
...
- 호랑이 위 까치는 머리 레이어보다 위에 두고 발 기준점을 큰 까치 `(335, 233)`, 작은 까치 `(340, 235)`로 고정
...
- 압축 해제 추정 메모리: 대화형 11.64MiB, AOD 정적 자산 5.82MiB
